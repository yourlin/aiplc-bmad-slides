...
const SLIDES = [
  ...
  // 12 · 酒店 SaaS 场景
  {
    ...
    zh: {
      ...
      cards: [
        ["场景一 · 需求优先级评估", "把分散的客户诉求归类、去重、按价值×成本打分排序"],
        ["场景二 · 经营数据简报", "从入住率 / 营收 / 渠道数据自动生成简报与趋势解读"],
        ["场景三 · 标书 / RFP 响应", "解读招标文件，抽取评分项，生成响应要点与差距清单"],
        ["可复用产出", "每个场景产出一个可复用的专家 Skill 或可运行原型"],
      ],
    },
    en: {
      title: "Hands-on scenarios: Hotel SaaS",
      subtitle: "Covering three typical PM workstreams — data insight / product decisions / document generation; customers may swap them",
      cards: [
        ["Scenario 1 · Requirement prioritization", "Categorize, de-duplicate, and rank scattered customer requests by value × cost"],
        ["Scenario 2 · Operations data briefing", "Auto-generate briefings and trend reads from occupancy / revenue / channel data"],
        ["Scenario 3 · Tender / RFP response", "Interpret tender docs, extract scoring items, produce response points and a gap list"],
        ["Reusable output", "Each scenario yields a reusable expert Skill or a runnable prototype"],
      ],
    },
  },
